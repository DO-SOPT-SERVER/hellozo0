...
import com.example.week3_hw.dto.request.member.MemberCreateRequest;
import com.example.week3_hw.dto.request.member.MemberGetResponse;
import com.example.week3_hw.dto.request.member.MemberProfileUpdateRequest;
import com.example.week3_hw.dto.response.ApiResponse;
import com.example.week3_hw.service.MemberService;
...
//        return ResponseEntity.noContent().build();
    ...
    public ApiResponse deleteMember(@PathVariable Long memberId) {
        ...
        return ApiResponse.success(SuccessMessage.DELETE_MEMBER_SUCCESS); // ✨[고칠것] 에러 메세지 - 회원정보가 없습니다 이런것을 포스트맨에서 보이게 하고싶음
//        return ResponseEntity.noContent().build();
    }
}